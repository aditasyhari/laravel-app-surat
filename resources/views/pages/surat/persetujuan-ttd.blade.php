            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Persetujuan TTD
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="col s12">
                        <div class="card">
                            <div class="card-content">
                                <h4 class="card-title">Data Pesetujuan TTD</h4>
                                <div class="row">
                                    <div class="col s12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col s2">
                                                                <a href="{{ url('persetujuan-ttd/detail-surat/'.$k->id_surat_keluar) }}" class="btn-floating waves-effect waves-light gradient-45deg-amber-amber btn-small" title="detail">
