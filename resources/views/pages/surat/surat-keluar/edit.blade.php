            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Edit Surat
                        </li>
                    </ol>
                </div>
                            ...
                            <div class="card-content">
                                ...
                                <div id="html-view-validations">
                                    <form class="formValidate0" id="formValidate0" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        @method('put')
                                        <div class="row">
                                            <input type="hidden" value="{{ $sk->id_pembuat }}" name="id_pembuat">
                                            <div class="input-field col s12">
                                                <label for="uname0">Nomor Surat</label>
                                                <input class="validate" required aria-required="true" name="" type="text" value="{{ $sk->nomor_surat }}" readonly>
                                            </div>
                                            <div class="col s12">
                                                <label for="role">Klasifikas Surat*</label>
                                                <input type="hidden" value="{{ $sk->kode_klasifikasi }}" name="kode_klasifikasi">
                                                <input class="validate" required aria-required="true" name="klasifikasi" type="text" value="{{ $sk->klasifikasi }}" readonly>
                                                <div class="input-field"></div>
                                            </div>

                                            <div class="input-field col s12">
                                                <input type="date" class="datepicker" value="{{ $sk->tgl_surat_fisik }}" name="tgl_surat_fisik">
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input name="id_validator" type="hidden" value="{{ $sk->id_validator }}">
                                                <input class="validate" readonly aria-required="true" type="text" value="{{ $sk->validator->nama }}">
                                            </div>

                                            <div class="input-field col s6">
                                                <label for="status">Persetujuan TTD*</label>
                                                <input name="id_ttd" type="hidden" value="{{ $sk->id_ttd }}">
                                                <input class="validate" readonly aria-required="true" type="text" value="{{ $sk->ttd->nama }}">
                                            </div>

                                            <div class="input-field col s12">
                                                <label for="tujuan">Tujuan Surat*</label>
                                                <input class="validate" required aria-required="true" id="tujuan" name="tujuan_surat" type="text" value="{{ $sk->tujuan_surat }}">
                                                <div class="input-field"></div>
                                            </div>

                                            <div class="input-field col s12">
                                                <label for="tujuan">Email Tujuan*</label>
                                                <input class="validate" required aria-required="true" name="email_tujuan" type="text" value="{{ $sk->email_tujuan }}">
                                                <div class="input-field"></div>
                                            </div>

                                            <div class="input-field col s12">
                                                <label for="perihal">Perihal*</label>
                                                <input class="validate" required aria-required="true" id="perihal" name="perihal" type="text" value="{{ $sk->perihal }}">
                                                <div class="input-field"></div>
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Kanan (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $sk->m_kanan }}" name="m_kanan" type="number">
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Kiri (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $sk->m_kiri }}" name="m_kiri" type="number">
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Atas (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $sk->m_atas }}" name="m_atas" type="number">
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Bawah (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $sk->m_bawah }}" name="m_bawah" type="number">
                                            </div>

                                            <div class="col s4">
                                                <label for="">Orientasi Halaman</label>
                                                <select class="error validate" name="orientasi_hal" aria-required="true" required>
                                                    <option {{ $sk->orientasi_hal == "landscape" ? "selected" : "" }} value="landscape">Landscape</option>
                                                    <option {{ $sk->orientasi_hal == "potrait" ? "selected" : "" }} value="potrait">Potrait</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col s4">
                                                ...
                                                <select class="error validate" name="ukuran_hal" aria-required="true" required>
                                                    <option value="A4" {{ $sk->ukuran_hal == "A4" ? "selected" : "" }}>A4</option>
                                                    <option value="F4" {{ $sk->ukuran_hal == "F4" ? "selected" : "" }}>F4</option>
                                                </select>
                                            </div>

                                            <div class="col s4">
                                                <label for="">Ukuran TTD (px)</label>
                                                <input class="validate" required aria-required="true" value="{{ $sk->ukuran_ttd }}" name="ukuran_ttd" type="number">
                                            </div>

                                            <div class="col s12">
                                                <label for="mytextarea">Kop Surat* (size gambar/logo harus kurang dari 1 mb)</label>
                                                <textarea id="layout_kop" name="layout_kop" required>{{ $sk->layout_kop }}</textarea>
                                            </div>
