                                    ...
                                    <form class="formValidate0" id="form-surat" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s3">
                                                ...
                                                <input class="validate" required aria-required="true" value="{{ $template->m_kanan }}" name="m_kanan" type="number">
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Kiri (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $template->m_kiri }}" name="m_kiri" type="number">
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Atas (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $template->m_atas }}" name="m_atas" type="number">
                                            </div>

                                            <div class="input-field col s3">
                                                <label for="">Margin Bawah (mm)</label>
                                                <input class="validate" required aria-required="true" value="{{ $template->m_bawah }}" name="m_bawah" type="number">
                                            </div>
