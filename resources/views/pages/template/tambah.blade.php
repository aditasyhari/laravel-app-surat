            ...
            <div class="row">
                <div class="col s10 m6 l6">
                    ...
                    <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Buat Template
                        </li>
                    </ol>
                </div>
                                ...
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l10">
                                            <h4 class="card-title">Buat Template Surat</h4>
                                    ...
                                    <form class="formValidate0" id="form-surat" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                ...
                                                <input class="validate" required aria-required="true" type="text" name="nama_template">
                                            </div>
                                            ...
                                            <div class="col s6">
                                                ...
                                                <select class="error validate" name="id_validator" aria-required="true" required>
                                                    ...
                                                    @foreach($validator as $v)
                                                        <option value="{{ $v->id_user }}" style="text-transform: uppercase">{{ $v->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col s6">
                                                ...
                                                <select class="error validate" name="id_klasifikasi" aria-required="true" required>
                                                    ...
                                                    @foreach($klasifikasi as $k)
                                                        <option value="{{ $k->id_klasifikasi }}" style="text-transform: uppercase">{{ $k->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
