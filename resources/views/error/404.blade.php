...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/page-500.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2019 16:43:05 GMT -->
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('app-assets/css/pages/page-500.css')}}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{asset('app-assets/images/gallery/error-2.png')}}" alt="" class="bg-image-500">
...
<!-- Mirrored from pixinvent.com/materialize-material-design-admin-template/html/ltr/vertical-modern-menu-template/page-500.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2019 16:43:07 GMT -->
</html>
