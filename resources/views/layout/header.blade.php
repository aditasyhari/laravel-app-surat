        ...
        <div class="nav-wrapper">
                ...
                @if (Auth::user()->foto == true)
                    <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                        data-target="profile-dropdown"><span class="avatar-status avatar-online"><img
                            src="{{asset('image/profile/'.Auth::user()->foto)}}" alt="avatar"><i></i></span></a></li>
                @else
                    <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                            data-target="profile-dropdown"><span class="avatar-status avatar-online"><img
                                    src="{{asset('app-assets/images/gallery/35.png')}}" alt="avatar"><i></i></span></a></li>
                @endif
            </ul>
            <!-- translation-button-->
            ...
            <ul class="dropdown-content" id="notifications-dropdown">
                ...
                <li><a class="grey-text text-darken-2" href="#!"><span
                            class="material-icons icon-bg-circle cyan small">assignment_returned</span>surat masuk</a>
                    <time class="media-meta" datetime="2015-06-12T20:50:48+08:00">2 baru</time>
                </li>
                <li><a class="grey-text text-darken-2" href="#!"><span
                            class="material-icons icon-bg-circle red small">assignment_turned_in</span>aprov
                        template</a>
                    <time class="media-meta" datetime="2015-06-12T20:50:48+08:00">3 baru</time>
                </li>
                <li><a class="grey-text text-darken-2" href="#!"><span
                            class="material-icons icon-bg-circle teal small">assignment</span>aprov surat</a>
